...
\usepackage{listings}   %Para comandos 
% Tablas
...
\setlist{nolistsep}
\definecolor{NavyBlue}{HTML}{1e90f0}
...
%% Datos del PFC
\newcommand{\titulo}{Desarrollo y despliegue de un workflow para el análisis genómico de \textit{Campylobacter jejuni}}
\newcommand{\autor}{Autor: José Antonio Barbero Aparicio}
\newcommand{\director}{Directores: José Francisco Díez Pastor y Beatriz Melero Gil}
\newcommand{\tutor}{Tutor: Nombre Apellido1 Apellido2}
\newcommand{\ponente}{Ponente: Alberto Suárez González}
...
\newcommand{\fecha}{Febrero 2019}
\newcommand{\carrera}{Máster en Bioinformática y Biología Computacional}
