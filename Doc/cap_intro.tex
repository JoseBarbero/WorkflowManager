...
\multicolumn{2}{l}{%
\textbf{\textcolor{NavyBlue}{Tarea 1 - Desarrollo de la imagen Docker }}}\\
...
\arrayrulecolor{NavyBlue}\hline
\multicolumn{2}{l}{%
\textbf{\textcolor{NavyBlue}{Tarea 2 - Desarrollo del workflow en Galaxy}}} \\
...
\arrayrulecolor{NavyBlue}\hline
\multicolumn{2}{l}{%
\textbf{\textcolor{NavyBlue}{Tarea 3 - Desarrollo de la interfaz de uso}}}\\
&
\begin{minipage}[t]{\linewidth}%
60 horas
\end{minipage}\\
